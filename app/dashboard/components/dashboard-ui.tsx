...
export const dashboardSurfaceClass =
  'rounded-2xl border border-gray-200/80 bg-white shadow-sm shadow-gray-950/[0.03]'

export const dashboardInsetSurfaceClass =
  'rounded-2xl border border-gray-200/80 bg-gray-50/70 shadow-sm shadow-gray-950/[0.02]'

export const primaryButtonClass =
  'inline-flex items-center justify-center rounded-xl bg-gray-900 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900 disabled:cursor-not-allowed disabled:opacity-60'

export const secondaryButtonClass =
  'inline-flex items-center justify-center rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm transition hover:border-gray-400 hover:bg-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-400 disabled:cursor-not-allowed disabled:opacity-60'
...
export const tableHeadClass =
  'bg-gray-50/90 text-left text-[11px] font-semibold uppercase tracking-[0.18em] text-gray-600'
export const tableRowClass =
  'border-b border-gray-100 transition-colors last:border-b-0 hover:bg-gray-50/80'
    ...
    <section className="space-y-4">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="max-w-3xl space-y-2">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-gray-500">{eyebrow}</p>
